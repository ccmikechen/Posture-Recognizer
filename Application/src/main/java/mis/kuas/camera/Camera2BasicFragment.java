...
public class Camera2BasicFragment extends Fragment {
    ...
    private OnCapturedListener onCapturedListener;
    /**
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File("/sdcard/stance/pics/pic.jpg");
    }
...
*/
    ...
    private void notifyOnCapturedListener() {
        if (this.onCapturedListener != null) {
            this.onCapturedListener.onCaptured(mFile);
        }
    }
