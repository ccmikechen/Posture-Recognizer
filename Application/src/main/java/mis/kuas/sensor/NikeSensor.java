...
public class NikeSensor {
	...
	public static void loadData(Resources res, float xScale, float yScale) {
		NikeSensor.xScale = xScale;
		NikeSensor.yScale = yScale;
		...
		Bitmap shoeBaseCover = BitmapFactory.decodeResource(res, R.drawable.cover);
	...
	public static byte[][] getShoeBaseMask(Direction direction) {
		return direction == Direction.LEFT ? leftShoeBaseMask : rightShoeBaseMask;
	}
	...
	public static ShoePoint[] getSensorPoints(Direction direction) {
		return direction == Direction.LEFT ? leftSensorPoints : rightSensorPoints;
	}

	public static Bitmap getShoeBaseCover(Direction direction) {
		return direction == Direction.LEFT ? leftShoeBaseCover : rightShoeBaseCover;
	}
